...
<h4 class="form-phone-heading">Phone details</h4>
    ...
    <label for="OUTSTANDING_AMOUNT">OUTSTANDING AMOUNT:</label><input type="number" class="input-block-level" name="OUTSTANDING_AMOUNT" placeholder="Update the amount to be payed"/>
