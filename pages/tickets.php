...
<div id='content' class='row-fluid'>
  ...
  <div class='span3 sidebar'>
	...
	<ul class="nav nav-list">
		...
		<li class="active"><a href="<?php echo $root."/tickets"; ?>" >Book Tickets</a></li>
		<li><a href="<?php echo $root."/bills"; ?>" >Pay Bills</a></li>
	</ul>
  </div>	
  <div class='span8 main'>
    <h3>Railway Ticket Details</h3>
    <?php include('forms/railway-info.php'); ?>
    <h3>Airline Ticket Details</h3>
    <?php include('forms/airline-info.php'); ?>
  </div>
</div>
<style type="text/css">
	.sidebar{
